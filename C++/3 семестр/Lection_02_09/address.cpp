...
void Address::setAddressRandomly() {
    int k = rand() % 8;
    const string countries[] = {"Russia", "Belarus", "Serbia", "Germany", "UK", "Italy", "France", "USA"};
    const string cities[] = {"Moscow", "Saint-Petersburg", "Minsk", "Bobruysk", "Belgrad", "Novi-Sad", "Berlin", "Munhen",
                             "London", "Manchester", "Rome", "Florence", "Paris", "Marcel", "Washington", "Miami"};
    const string streets[] = {"Forest", "Central", "University", "Park", "Main", "School"};
...
ostream& operator<<(ostream& output, const Address& a) {
    output << "Country: " << a.country << ", City: " << a.city
           << ", Street: " << a.street
           << ", House: " << a.house
           << ", Apartment: " << a.apartment << endl;
